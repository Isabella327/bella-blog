...
const config = {
  ...
  favicon: 'img/donut.ico',

  // GitHub pages deployment config.
  // If you aren't using GitHub pages, you don't need these.
  organizationName: 'Isabella327', // Usually your GitHub org/user name.
  projectName: 'bellasblog', // Usually your repo name.
    ...
    ({
      navbar: {
        ...
        items: [
          ...
          {
            href: 'https://github.com/Isabella327',
            label: 'GitHub',
            position: 'right',
          },
        ],
